...
namespace qsf
{
	namespace editor2
	{
		...
		*/
		...
		//[-------------------------------------------------------]
		public:
			static GlobalAssetId cloneTerrainAssets(const TerrainDefinition& sourceTerrainDefinition, qsf::editor::AssetEditHelper& assetEditHelper, TerrainDefinition& targetTerrainDefinition, const std::string& targetAssetPackageName);
		...
		public:
			...
			*/
			...
			qsf::editor::TerrainDataMap* getTerrainDataMap(qsf::editor::TerrainDataType dataType, bool createIfNotExist = true);
			void updateOgreMap(qsf::editor::TerrainDataType dataType);
			...
			void importMap(qsf::editor::TerrainDataType dataType, const std::string& absoluteFilename, bool scaleAndBias, float minimumValue, float maximumValue);
			void exportMap(qsf::editor::TerrainDataType dataType, const std::string& absoluteFilename, bool normalize);
			void importChannel(qsf::editor::TerrainDataType dataType, int channelIndex, const std::string& absoluteFilename, float heightMapScale);
			void exportChannel(qsf::editor::TerrainDataType dataType, int channelIndex, const std::string& absoluteFilename);
		...
		private:
			...
			*/
			...
			GlobalAssetId getSourceDataGlobalAssetId(qsf::editor::TerrainDataType dataType) const;
			void saveSourceData(qsf::editor::TerrainDataType dataType);
		...
		private:
			...
			qsf::editor::TerrainData							 mTerrainData;
			std::shared_ptr<qsf::editor::AssetEditHelper>	 mAssetEditHelper;
			std::string							 mTargetAssetPackageName;
			std::unordered_set<qsf::editor::TerrainDataType>	 mModifiedTerrainDataTypes;
